  ...
  useEffect(() => {
    const wordInterval = setInterval(() => {
      ...
      if (currentWordLength < targetWord.length)
        setCurrentWord(targetWord.substring(0, currentWordLength + 1));
      else {
    ...
    <div>
      <div id="inicio" className="relative">
        ...
        >
          ...
          <p className="text-white text-2xl lg:text-3xl font-bold mt-4">
            Carlos Carbajal Matias
          </p>
          <p className="text-white text-xl lg:text-2xl font-bold mt-4">
          ...
          <Button
            ...
            onFunction={() =>
              window.open(
                "https://www.linkedin.com/in/carlos-carbajal-matias-35a1b8188/",
                "_blank"
              )
            }
          />
